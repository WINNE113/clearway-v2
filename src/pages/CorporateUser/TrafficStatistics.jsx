                        ...
                        <div className="h-[400px] mt-4">
                            <ResponsiveContainer width="100%" height="100%">
                                ...
                                >
                                    ...
                                    <XAxis
                                        dataKey="hour"
                                        label={{ value: 'Thời gian (giờ)', position: 'insideBottomRight', offset: -10 }}
                                    />
                                    <YAxis
                                        yAxisId="left"
                                        label={{ value: 'Mật độ (g/cm³)', angle: -90, position: 'insideLeft' }}
                                    />
                                    <YAxis
                                        yAxisId="right"
                                        orientation="right"
                                        label={{ value: 'Tốc độ (km/h)', angle: 90, position: 'insideRight' }}
                                    />
                                    <Tooltip />
                                    <Legend />
                                    <Line
                            ...
                            <table className="min-w-full bg-white">
                                <thead>
                                    <tr className="bg-gray-200 text-gray-600 text-sm leading-normal">
                                        ...
                                        <th className="py-2 px-2 text-left">Tình trạng tuyến đường (Hiện tại)</th>
                                ...
                                <tbody className="text-gray-600 text-sm font-light">
                                    {dataStreet.map((data) => (
                                        <tr key={data.id} className="border-b border-gray-200 hover:bg-gray-100">
                                            <td className="py-2 px-2 text-left font-bold">{data.nameStreet}</td>
                                            <td className="py-2 px-2 text-left font-bold">{data.status}</td>
